...
def trace_articles_by_clusters(entries, labels, keyword):
    relevant_entries = []
...
def main(input_file, output_file, num_clusters, keyword):
    ...
    relevant_entries = trace_articles_by_clusters(bib_database.entries, labels, keyword)
